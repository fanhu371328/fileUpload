...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.ruthout.com/index.php/Home/Wxpay/notify';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.ruthout.com/index.php/Home/Wxpay/notify';

	//=======【curl超时设置】===================================
	//本例程通过curl使用HTTP POST方法，此处可修改其超时时间，默认为30秒
	public $CURL_TIMEOUT = 50;
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wxf489e68d07315c8f';
			//受理商ID，身份标识
			$this->MCHID = '1291259401';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'ece3c7b6bf18ebf0601c3c427960d40a';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'e66f35b794e0e481fa2c78d02f807e8f';
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
